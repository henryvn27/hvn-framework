# ORCA Framework Ecosystem Sweep Automation

- Automation id: `orca-ecosystem-sweep`
- Automation name: `ORCA Framework Ecosystem Sweep`
...
Run a research-first strategic sweep for the ORCA Framework ecosystem without changing product code by default. The sweep tracks execution-capability changes, setup-path changes for important external integrations, startup-stack integration drift across web and mobile ecosystems, a dedicated harness compatibility audit, top-level docs surfaces that should refresh as the framework changes, and design/copy quality signals that help ORCA Framework avoid generic AI-looking output.

Primary research question:

> What new host or framework capabilities now exist that ORCA Framework can exploit, wrap, adapt, or learn from?
...
> Which tools still deserve default recommendation for a specific ORCA Framework use case, and which should move to neutral support only?
...
- do not edit ORCA Framework product code by default
...
```markdown
# ORCA Framework Ecosystem Sweep - YYYY-MM-DD
...
- whether ORCA Framework can exploit it directly
- evidence/source
- classification
- adoption shape
- primary category
...
- whether ORCA Framework setup docs should change
...
- whether ORCA Framework's default stack recommendation should change
...
## Recommended next ORCA Framework moves
- build now
- research next
...
- easier setup paths ORCA Framework could recommend
- broken or deprecated setup paths ORCA Framework should stop recommending
...
- capability parity gaps that matter to ORCA Framework workflows
...
- patterns that help ORCA Framework outputs look more intentional, product-specific, and less obviously AI-generated
- domain-specific design or writing tools ORCA Framework should coordinate with rather than clone
...
- host-level token visibility or usage reporting ORCA Framework can expose honestly
...
2. audit current support for ORCA Framework-relevant capabilities and integrations
...
- `Adopt now`: ORCA Framework should open a draft issue and plan a concrete framework change.
...
- `Ignore for now`: low leverage, stale, too host-specific, or outside ORCA Framework scope.
...
- Can ORCA Framework actually use this?
- Is it host-specific or portable?
- What would ORCA Framework need to change to benefit?
...
- Who is affected?
- Does ORCA Framework documentation or workflow guidance need to change?
...
- Which ORCA Framework workflows does the shift affect?
...
- Should ORCA Framework update `orca-design`, `docs/visual-quality.md`, `docs/human-voice.md`, or a user-facing guide?
...
- Should ORCA Framework update `docs/token-efficiency.md`, stage budgets, runtime guidance, or workflow accounting?
...
- Should ORCA Framework update an integration pack, stack guide, validation rule, or paved road?
...
- Should ORCA Framework recommend it, downgrade it to neutral support, or only help when user-chosen?
...
- Should ORCA Framework recommend Graphify, support it only when user-chosen, or stay silent?

Avoid hype summaries, copied release notes, trivia, and findings without a recommended ORCA Framework action.
...
- classify setup-path changes as `Adopt now` when they materially improve or break ORCA Framework guidance and should be acted on now
- classify compatibility shifts as `Adopt now` when they materially improve or break ORCA Framework guidance and should be acted on now
...
- capability-to-ORCA Framework mapping is explicit
- setup-path changes explain who is affected and whether ORCA Framework guidance should change
- harness compatibility shifts explain what changed, which workflows are affected, and whether ORCA Framework docs should change
