...
- Ideal use cases: CRM and sales or customer workflow integration
- Setup requirements: account access, API or workflow path
- Permissions or credentials: HubSpot credentials
