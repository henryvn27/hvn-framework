...
- Ideal use cases: AI request monitoring, cost visibility, routing observability
- Setup requirements: proxy or SDK integration path
- Permissions or credentials: Helicone credentials
