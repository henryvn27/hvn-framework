...
- Ideal use cases: team notifications, workflow alerts, ops loops
- Setup requirements: workspace app or webhook path
- Permissions or credentials: workspace app access or webhook secret
