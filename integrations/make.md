...
- Ideal use cases: cross-tool automation with visual workflow composition
- Setup requirements: scenario setup, service auth
- Permissions or credentials: Make access and service credentials
