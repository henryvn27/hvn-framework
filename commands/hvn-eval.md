...
Evaluate an HVN workflow or run using trajectory-aware checks instead of grading only the final artifact.
...
- Commands: `hvn-trace`, `hvn-review`, `hvn-ship`
- Skills: `hvn-eval`, `hvn-observability`
