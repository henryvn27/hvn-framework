...
Guide external tool setup for the current HVN workflow.
...
- Commands: `hvn-check-setup`, `hvn-validate-integration`, `hvn-next`
- Skills: `hvn-tool-setup`, `hvn-tool-governance`
