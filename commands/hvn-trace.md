...
Create a practical run trace for a meaningful HVN session, phase, or handoff.
...
- Commands: `hvn-eval`, `hvn-review`, `hvn-ship`
- Skills: `hvn-observability`
