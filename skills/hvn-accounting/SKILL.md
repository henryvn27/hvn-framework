---
name: hvn-accounting
description: Record time, retries, and optional cost metrics for HVN workflows without fabricating precision.
---
...
Supports `hvn-trace`, `hvn-eval`, `hvn-review`, QA workflows, and `hvn-metrics`.
