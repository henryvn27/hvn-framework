---
name: hvn-eval
description: Evaluate HVN workflows by scoring trajectories, artifact quality, and final usefulness.
---
...
A trajectory-based evaluation workflow for judging how well HVN behaved, not just what it produced.

## Trigger

Use when validating a workflow, comparing changes to HVN, or reviewing whether a command or skill is trustworthy.
...
Works with `hvn-trace`, `hvn-spec`, `hvn-plan`, QA skills, and `hvn-ship`.
