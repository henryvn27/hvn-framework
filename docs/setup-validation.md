...
Setup validation checks whether an integration can support the intended ORCA Framework action. It should avoid destructive writes unless the user approved them.
