...
An ORCA Framework issue is a durable thread of decisions, artifacts, and evidence. Linear is the default issue system; opt-out mode uses an equivalent durable work item.
