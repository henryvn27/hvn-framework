...
Replay and restore help HVN compare behavior across versions, harnesses, prompts, policies, and compatibility changes.
...
- debugging regressions after HVN changes
