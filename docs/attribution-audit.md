...
- Is the root [LICENSE](../LICENSE) limited to ORCA-HVN's own license?
...
- Does the repo describe originality honestly without underselling ORCA-HVN's own design work?

## Failure Signals

- "inspired by various tools" with no names
- wrapper behavior described as if it were fully native ORCA-HVN capability
