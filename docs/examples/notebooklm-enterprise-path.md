...
- call out IAM roles, licensing, and project requirements
- treat API support as official for notebook management and source operations
- avoid implying a universal consumer API
