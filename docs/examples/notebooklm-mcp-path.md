...
- verify the chosen tool actually works locally
- recommend a dedicated or controlled account for automation when appropriate
- keep the user aware that this path may break with UI or auth changes
