...
5. add feature-level provenance if users need to understand the adaptation

## What Not To Do

- do not hide the bundled source behind a vague "inspired by" line
- do not rely only on a GitHub link when preserved notice text is required
