...
This page helps returning users rediscover what changed without reading every file.

## Recently Added Capability Areas

- background mode for bounded unattended progress
