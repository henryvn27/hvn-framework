...
Degraded mode lets HVN continue when an external integration is missing, optional, or partially available.
...
Degraded mode is acceptable when the user can still complete the HVN phase with clear manual steps and no hidden loss of evidence.
